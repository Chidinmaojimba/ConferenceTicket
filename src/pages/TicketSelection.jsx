...
const handleNext = () => {
  ...
  return (
    <>
    <div className='flex flex-col items-center justify-center w-full h-full md:px-12 text-white text-sm bg-gradient-to-t from-[#0E464F] to-[#08252B] roboto-regular'>
        <TicketNav />
          <div className='border border-[#0E464F] py-2 px-4 my-5 mb-40 rounded-xl bg-[#08252B]'>
            <div className='flex md:flex-row flex-col text-left'>
                <div className='text-lg'>Ticket Selection</div>
            ...
            <div className='border border-[#0E464F] px-2 lg:px-12 py-4 flex flex-col items-center justify-center text-center rounded-lg my-2 bg-gradient-to-b from-[#0E464F] to-[#08252B]'>
                ...
                <div className='text-[15px] mt-1'>:round_pushpin: [Event Location] | | March 15, 2025 | 7:00 PM</div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 my-4 w-full">
